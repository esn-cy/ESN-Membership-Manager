...
class BothConfirmationEmail extends MembershipEmailBase implements EmailInterface
{
    private string $name;
    ...
    public function getSubject(): string
    {
        ...
        return "$schemeName and ESNcard Application Received";
    }
